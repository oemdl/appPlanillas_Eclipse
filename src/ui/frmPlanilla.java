...
public class frmPlanilla extends JFrame implements Runnable {
	...
	public frmPlanilla() {
		...
		try {
			BufferedImage bufferedImage = ImageIO.read( new File( getClass().getResource("/ui/img/fondoApp.png" ).getFile() ) );
			imageFondo = bufferedImage.getScaledInstance(1366, 650, Image.SCALE_DEFAULT);
			
			bufferedImage = ImageIO.read( new File( getClass().getResource("/ui/img/logoMenu_1.png" ).getFile() ) );
			imageMenu = bufferedImage.getScaledInstance(230, 50, Image.SCALE_DEFAULT);
		} catch (IOException e) { e.printStackTrace(); }
	
		dpPlanilla = new JDesktopPane();
		dpPlanilla.setBounds(300,50,1065,680);
		dpPlanilla.setVisible(false);
		getContentPane().add(dpPlanilla);
		...
		lblUsuario.setBounds(600,735,200,30);
		getContentPane().add(lblUsuario);
		
		lblFecha = new JLabel();
		lblFecha.setBounds(1100,735,150,30);
		getContentPane().add(lblFecha);
		
		lblHora = new JLabel();
		lblHora.setBounds(1250,735,150,30);
		...
		imgLogo.setIcon(new ImageIcon(getClass().getResource("/ui/img/logo.png")));
		pnlApp.add(imgLogo);
		
		JLabel imgCerrar = new JLabel();
		imgCerrar.setBounds(1320,9,32,32);
		imgCerrar.setIcon(new ImageIcon(getClass().getResource("/ui/img/cerrar.png")));
		...
		btnPlanillas.setBounds(400,0,100,50);
		...
		btnInformes.setBounds(500,0,100,50);
		...
		btnConfiguraciones.setBounds(600,0,170,50);
		...
		btnUtilitarios.setBounds(770,0,120,50);
		...
		pnlMenu = new JPanel();
		pnlMenu.setBounds(0,50,300,680);
		...
		btnTrabajadores.addMouseListener(new MouseAdapter() { 
			public void mouseEntered(MouseEvent e) { btnApp_mouseEntered(e); } 
			public void mouseExited(MouseEvent e) { btnApp_mouseExited(e); }	
			public void mouseClicked(MouseEvent e) { btnMenuPlanilla_mouseClicked(1);	} } );
		
		btnPlanillas.addMouseListener(new MouseAdapter() { 
			public void mouseEntered(MouseEvent e) { btnApp_mouseEntered(e); } 
			public void mouseExited(MouseEvent e) { btnApp_mouseExited(e); } 
			public void mouseClicked(MouseEvent e) { btnMenuPlanilla_mouseClicked(2); } } );
		
		btnInformes.addMouseListener(new MouseAdapter() { 
			public void mouseEntered(MouseEvent e) { btnApp_mouseEntered(e); } 
			public void mouseExited(MouseEvent e) { btnApp_mouseExited(e); } 
			public void mouseClicked(MouseEvent e) { btnMenuPlanilla_mouseClicked(3); } });
		
		btnConfiguraciones.addMouseListener(new MouseAdapter() { 
			public void mouseEntered(MouseEvent e) { btnApp_mouseEntered(e); } 
			public void mouseExited(MouseEvent e) { btnApp_mouseExited(e); } 
			public void mouseClicked(MouseEvent e) { btnMenuPlanilla_mouseClicked(4); } });
	
		btnUtilitarios.addMouseListener(new MouseAdapter() { 
			public void mouseEntered(MouseEvent e) { btnApp_mouseEntered(e); } 
			public void mouseExited(MouseEvent e) { btnApp_mouseExited(e); } 
			public void mouseClicked(MouseEvent e) { btnMenuPlanilla_mouseClicked(5); } });

		imgMenu01.addMouseListener(new MouseAdapter() {  public void mouseClicked(MouseEvent e) { imgMenu_mouseClicked(1); } });
		imgMenu02.addMouseListener(new MouseAdapter() {  public void mouseClicked(MouseEvent e) { imgMenu_mouseClicked(2); } });
		imgMenu03.addMouseListener(new MouseAdapter() {  public void mouseClicked(MouseEvent e) { imgMenu_mouseClicked(3); } });
		imgMenu04.addMouseListener(new MouseAdapter() {  public void mouseClicked(MouseEvent e) { imgMenu_mouseClicked(4); } });
		imgMenu05.addMouseListener(new MouseAdapter() {  public void mouseClicked(MouseEvent e) { imgMenu_mouseClicked(5); } });
		imgMenu06.addMouseListener(new MouseAdapter() {  public void mouseClicked(MouseEvent e) { imgMenu_mouseClicked(6); } });
		imgMenu07.addMouseListener(new MouseAdapter() {  public void mouseClicked(MouseEvent e) { imgMenu_mouseClicked(7); } });
		imgMenu08.addMouseListener(new MouseAdapter() {  public void mouseClicked(MouseEvent e) { imgMenu_mouseClicked(8); } });
		imgMenu09.addMouseListener(new MouseAdapter() {  public void mouseClicked(MouseEvent e) { imgMenu_mouseClicked(9); } });
		imgMenu10.addMouseListener(new MouseAdapter() {  public void mouseClicked(MouseEvent e) { imgMenu_mouseClicked(10); } });

		lblSubMenu01.addMouseListener(new MouseAdapter() { 
			 public void mouseEntered(MouseEvent e) { lblSubMenu_mouseEntered(e); }
			 public void mouseExited(MouseEvent e) { lblSubMenu_mouseExited(e); }
			 public void mouseClicked(MouseEvent e) { lblSubMenu_mouseClicked(1); } } );
		lblSubMenu02.addMouseListener(new MouseAdapter() { 
			 public void mouseEntered(MouseEvent e) { lblSubMenu_mouseEntered(e); }
			 public void mouseExited(MouseEvent e) { lblSubMenu_mouseExited(e); }
			 public void mouseClicked(MouseEvent e) { lblSubMenu_mouseClicked(2); } } );
		lblSubMenu03.addMouseListener(new MouseAdapter() { 
			 public void mouseEntered(MouseEvent e) { lblSubMenu_mouseEntered(e); }
			 public void mouseExited(MouseEvent e) { lblSubMenu_mouseExited(e); }
			 public void mouseClicked(MouseEvent e) { lblSubMenu_mouseClicked(3); } } );
		lblSubMenu04.addMouseListener(new MouseAdapter() { 
			 public void mouseEntered(MouseEvent e) { lblSubMenu_mouseEntered(e); }
			 public void mouseExited(MouseEvent e) { lblSubMenu_mouseExited(e); }
			 public void mouseClicked(MouseEvent e) { lblSubMenu_mouseClicked(4); } } );
		lblSubMenu05.addMouseListener(new MouseAdapter() { 
			 public void mouseEntered(MouseEvent e) { lblSubMenu_mouseEntered(e); }
			 public void mouseExited(MouseEvent e) { lblSubMenu_mouseExited(e); }
			 public void mouseClicked(MouseEvent e) { lblSubMenu_mouseClicked(5); } } );
		lblSubMenu06.addMouseListener(new MouseAdapter() { 
			 public void mouseEntered(MouseEvent e) { lblSubMenu_mouseEntered(e); }
			 public void mouseExited(MouseEvent e) { lblSubMenu_mouseExited(e); }
			 public void mouseClicked(MouseEvent e) { lblSubMenu_mouseClicked(6); } } );
		lblSubMenu07.addMouseListener(new MouseAdapter() { 
			 public void mouseEntered(MouseEvent e) { lblSubMenu_mouseEntered(e); }
			 public void mouseExited(MouseEvent e) { lblSubMenu_mouseExited(e); }
			 public void mouseClicked(MouseEvent e) { lblSubMenu_mouseClicked(7); } } );
		lblSubMenu08.addMouseListener(new MouseAdapter() { 
			 public void mouseEntered(MouseEvent e) { lblSubMenu_mouseEntered(e); }
			 public void mouseExited(MouseEvent e) { lblSubMenu_mouseExited(e); }
			 public void mouseClicked(MouseEvent e) { lblSubMenu_mouseClicked(8); } } );
		lblSubMenu09.addMouseListener(new MouseAdapter() { 
			 public void mouseEntered(MouseEvent e) { lblSubMenu_mouseEntered(e); }
			 public void mouseExited(MouseEvent e) { lblSubMenu_mouseExited(e); }
			 public void mouseClicked(MouseEvent e) { lblSubMenu_mouseClicked(9); } } );
		lblSubMenu10.addMouseListener(new MouseAdapter() { 
			 public void mouseEntered(MouseEvent e) { lblSubMenu_mouseEntered(e); }
			 public void mouseExited(MouseEvent e) { lblSubMenu_mouseExited(e); }
			 public void mouseClicked(MouseEvent e) { lblSubMenu_mouseClicked(10); } } );
		lblSubMenu11.addMouseListener(new MouseAdapter() { 
			 public void mouseEntered(MouseEvent e) { lblSubMenu_mouseEntered(e); }
			 public void mouseExited(MouseEvent e) { lblSubMenu_mouseExited(e); }
			 public void mouseClicked(MouseEvent e) { lblSubMenu_mouseClicked(11); } } );
		lblSubMenu12.addMouseListener(new MouseAdapter() { 
			 public void mouseEntered(MouseEvent e) { lblSubMenu_mouseEntered(e); }
			 public void mouseExited(MouseEvent e) { lblSubMenu_mouseExited(e); }
			 public void mouseClicked(MouseEvent e) { lblSubMenu_mouseClicked(12); } } );
		lblSubMenu13.addMouseListener(new MouseAdapter() { 
			 public void mouseEntered(MouseEvent e) { lblSubMenu_mouseEntered(e); }
			 public void mouseExited(MouseEvent e) { lblSubMenu_mouseExited(e); }
			 public void mouseClicked(MouseEvent e) { lblSubMenu_mouseClicked(13); } } );
	}
	...
	protected void form_windowsOpened() {
		...
		lblSaludo.setText("    Hola " + ( empleado.getNombres() + " " + empleado.getApellidoPaterno() ) + " ,Bienvenido al Sistema de Planilla X6");
		lblUsuario.setText( "Usuario : " + ( empleado.getNombres() + " " + empleado.getApellidoPaterno() ) );
	...
	protected void imgMenu_mouseClicked(int menu) {
		...
		for( int i=0, filaMenu=0; i < aMenu[MenuPlanilla].length; i++ ) {
			...
			aLblMenu[i].setIcon(new ImageIcon(getClass().getResource("/ui/img/menu" + (MenuPlanilla + 1) + (i + 1) + ".png")));
			aLblMenu[i].setText( aMenu[MenuPlanilla][i] );
			aLblMenu[i].setVisible(true);
			
			aImgMenu[i].setBounds(270,filaMenu,20,20);
			aImgMenu[i].setIcon(new ImageIcon(getClass().getResource("/ui/img/" + ( i != Menu ? "abajo" : "arriba" ) + ".png")));
		...
		switch ( MenuPlanilla ) {
			case 0:
				switch ( Menu ) {
					...
					case 2 :
						switch ( SubMenu ) {
							case 2: formulario = new frmSede(); break; 
