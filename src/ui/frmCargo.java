...
public class frmCargo extends JInternalFrame {
	...
	public frmCargo() {
		...
		btnAgregar.setIcon(new ImageIcon(frmCargo.class.getResource("/ui/img/agregar.png")));
		...
		btnEditar.setIcon(new ImageIcon(frmCargo.class.getResource("/ui/img/editar.png")));
		...
		btnEliminar.setIcon(new ImageIcon(frmCargo.class.getResource("/ui/img/eliminar.png")));
		...
		btnGuardar.setIcon(new ImageIcon(frmCargo.class.getResource("/ui/img/guardar.png")));
		...
		btnCancelar.setIcon(new ImageIcon(frmCargo.class.getResource("/ui/img/cancelar.png")));
